...
import 'package:tablet_app_9/singscreen/sign_screen_2.dart';

class ThemeScreen2 extends StatefulWidget {
  const ThemeScreen2({super.key});

  @override
  State<ThemeScreen2> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ThemeScreen2> {
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
                child:InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> SignScreen_2(title: '2번테마'))
                    );
                  },
                  child: Container(
                    margin: EdgeInsets.only(top: 15, bottom: 15),
