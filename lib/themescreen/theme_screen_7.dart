...
import 'package:tablet_app_9/singscreen/sign_screen_7.dart';

final skyblue = 0x99add8e6;

class ThemeScreen7 extends StatefulWidget {
  const ThemeScreen7({super.key});

  @override
  State<ThemeScreen7> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ThemeScreen7> {
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
                child:InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> SignScreen_7(title: '7번 테마'))
                    );
                  },
                  child: Container(
                    margin: EdgeInsets.only(top: 15, bottom: 15),
