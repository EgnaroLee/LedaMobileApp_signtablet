...
import 'package:tablet_app_9/singscreen/sign_screen_8.dart';

final skyblue = 0x99add8e6;

class ThemeScreen8 extends StatefulWidget {
  const ThemeScreen8({super.key});

  @override
  State<ThemeScreen8> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ThemeScreen8> {
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
                child:InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> SignScreen_8(title: '8번 테마'))
                    );
                  },
                  child: Container(
                    margin: EdgeInsets.only(top: 15, bottom: 15),
