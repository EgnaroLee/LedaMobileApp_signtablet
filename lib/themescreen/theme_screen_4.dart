...
import 'package:tablet_app_9/singscreen/sign_screen_4.dart';

final skyblue = 0x99add8e6;

class ThemeScreen4 extends StatefulWidget {
  const ThemeScreen4({super.key});

  @override
  State<ThemeScreen4> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ThemeScreen4> {
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
                child:InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> SignScreen_4(title: '4번테마'))
                    );
                  },
                  child: Container(
                    margin: EdgeInsets.only(top: 15, bottom: 15),
