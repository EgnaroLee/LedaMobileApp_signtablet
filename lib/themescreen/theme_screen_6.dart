...
class ThemeScreen6 extends StatefulWidget {
  ...
  @override
  State<ThemeScreen6> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ThemeScreen6> {
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
                child:InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> SignScreen_6(title: '6번 테마'))
                    );
                  },
                  child: Container(
                    margin: EdgeInsets.only(top: 15, bottom: 15),
