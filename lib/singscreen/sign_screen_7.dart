...
class SignScreen_7 extends StatefulWidget {
  const SignScreen_7({super.key, required this.title});

  final String title;

  @override
  State<SignScreen_7> createState() => _SignScreenState();
}



class _SignScreenState extends State<SignScreen_7> {
